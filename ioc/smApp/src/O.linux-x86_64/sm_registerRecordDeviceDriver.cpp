...
/* Generated from ../O.Common/sm.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "devMotorAsyn", "devMotorSoft", "devPrintfSoft",
...
int sm_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/blctrl/blcg/blcg-galil-ioc/ioc";
...
/* sm_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"sm_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    sm_registerRecordDeviceDriver(*iocshPpdbbase);
}
